...
# ------------------------
new_list.filter("EventItem")

# Testing Trip Item
# --------------------
new_list.add("trip", "Trip to Spain", start_date: "Dec 20", end_date: "Dec 30")
new_list.all

# Test remove elements with due or end date in the past
# -----------------------------------------------------
new_list.add("trip", "Trip to Japan", start_date: "2015-05-28", end_date: "2015-05-31")
new_list.all
new_list.remove_past_items()
new_list.all